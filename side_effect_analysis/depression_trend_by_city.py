...
def main():
    # open tweet files
    tweets = open("tweetsWithCities0.txt", "r")
    tweets2 = open("tweetsWithCities1.txt", "r")
    ...
    city_list = []
    if sys.argv[1] == "LosAngeles":
        city_list = ["Los Angeles", "CA"]
        print("Analysis for ", sys.argv[1])
    elif sys.argv[1] == "NewYork":
        city_list = ["New York"]
        print("Analysis for ", sys.argv[1])
    elif sys.argv[1] == "Detroit":
        city_list = ["Detroit"]
        print("Analysis for ", sys.argv[1])
    elif sys.argv[1] == "Boston":
        city_list = ["Boston"]
        print("Analysis for ", sys.argv[1])
    elif sys.argv[1] == "Chicago":
        city_list = ["Chicago"]
        print("Analysis for ", sys.argv[1])
    elif sys.argv[1] == "Philadelphia":
        city_list = ["Philadelphia"]
        print("Analysis for ", sys.argv[1]) 
    elif sys.argv[1] == "Miami":
        city_list = ["Miami"]
        print("Analysis for ", sys.argv[1])
    else:
        print("Cities not on the list. Currently available for top affected cities no space [LosAngeles | Boston | Miami | Chicago | Philadelphia | NewYork | Detroit]")     
